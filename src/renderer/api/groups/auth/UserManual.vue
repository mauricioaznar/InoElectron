        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <ul>
                    ...
                    <li>Editar un cliente</li>
                    <li>Eliminar un cliente</li>
                    <li>Buscar un cliente</li>
                    <li>Ver un cliente</li>
                    <li>Crear una empresa</li>
                    <li>Editar una empresa</li>
                    <li>Eliminar una empresa</li>
                    <li>Buscar una empresa</li>
                    <li>Ver una empresa</li>
                    <li>Crear una venta</li>
                    <li>Editar una venta</li>
                    <li>Eliminar una venta</li>
                    <li>Buscar una venta</li>
                    <li>Ver una venta</li>
                    <li>Crear un pedido</li>
                    <li>Editar un pedido</li>
        ...
        <div class="row">
            ...
            <div class="col-sm-12">
                <ul>
                    ...
                    <li>Ver un producto</li>
                    <li>Crear una orden de ajuste</li>
                    <li>Editar una orden de ajuste</li>
                    <li>Eliminar una orden de ajuste</li>
                    <li>Buscar una orden de ajuste</li>
                    <li>Ver una orden de ajuste</li>
                    <li>Crear una orden de producción</li>
                    <li>Editar una orden de producción</li>
                    <li>Eliminar una orden de producción</li>
                    <li>Buscar una orden de producción</li>
                    <li>Ver una orden de producción</li>
                    <li>Crear un empleado</li>
                    <li>Editar un empleado</li>
                    <li>Eliminar un empleado</li>
                    <li>Buscar un empleado</li>
                    <li>Ver un empleado</li>
                    <li>Crear una máquina</li>
                    <li>Editar una máquina</li>
                    <li>Eliminar una máquina</li>
                    <li>Buscar una máquina</li>
                    <li>Ver una máquina</li>
                </ul>
            </div>
        </div>
    </div>
